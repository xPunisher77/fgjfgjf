...
.addStringOption(option =>    
    ...
    .setRequired(true))
    .addStringOption(option =>    
      option.setName('mysqluser')
      .setDescription('Your User')
      .setRequired(true))
      .addStringOption(option =>    
        option.setName('mysqlpassword')
        .setDescription('Your password')
        .setRequired(true)),
...
let mysqluser = 'mysqluser'
let value4 = await interaction.options.getString("mysqluser")
let mysqlpassword = 'mysqlpassword'
let value5 = await interaction.options.getString("mysqlpassword")
...
interaction.reply({ content: `✅ - **Successfully creating a new account**
**Winter Hosting, <:951538512778395650:1029825477910745108>  Multi Theaft Server :
\nOGP : https://panel.winter-host.xyz//
\nUser: ||${value1}||
\nPassword: ||${value2}||

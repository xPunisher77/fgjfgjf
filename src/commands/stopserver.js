...
interaction.reply({ content: `✅ - **Successfully Stop A Server**`, ephemeral: false }).then(async (res)  => {
...
var link = `http://141.95.225.55/ogp_api.php?gamemanager/stop&token=${gettoken}&ip=${value1}&port=${value2}&mod_key=default`;
